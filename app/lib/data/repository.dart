...
abstract class XyRepository {
  ...
  // ---------- profil ----------
  Future<UserProfile> perbaruiProfil({String? nama, String? phone, String? foto});
...
class RemoteRepository implements XyRepository {
  ...
  @override
  Future<UserProfile> perbaruiProfil({String? nama, String? phone, String? foto}) async =>
...
class MockRepository implements XyRepository {
  ...
  @override
  Future<UserProfile> perbaruiProfil({String? nama, String? phone, String? foto}) => _delay(MockData.user, 400);
