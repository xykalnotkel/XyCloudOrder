        ...
        children: [
          Container(
            ...
            child: Column(children: [
              ...
              const Text('Top Spender Bulan Ini', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800, fontSize: 16)),
          ...
          ...mockTop.asMap().entries.map((e) {
            ...
            return Padding(
              ...
              child: XyCard(
                ...
                child: Row(children: [
                  Container(width: 36, height: 36, decoration: BoxDecoration(color: i == 0 ? const Color(0xFFE8C07A) : XyTheme.of(context).primarySoft, shape: BoxShape.circle), child: Center(child: Text('${i+1}', style: TextStyle(fontWeight: FontWeight.w800, color: i==0? Colors.black: XyTheme.primary)))),
                  const SizedBox(width: 12),
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Row(children: [
                      Text(m['nama'] as String, style: const TextStyle(fontWeight: FontWeight.w800)),
                      if ((m['badge'] as String).isNotEmpty) ...[
                        const SizedBox(width: 6),
                        Container(padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2), decoration: BoxDecoration(color: XyTheme.primary, borderRadius: BorderRadius.circular(6)), child: Text(m['badge'] as String, style: const TextStyle(color: Colors.white, fontSize: 9, fontWeight: FontWeight.w800))),
                      ],
                    ]),
          ...
          XyCard(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Text('Cara dapat poin', style: TextStyle(fontWeight: FontWeight.w800)),
