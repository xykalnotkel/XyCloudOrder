                    ...
                    XyCard(
                      child: Column(children: [
                        Row(children: [
                          Expanded(
                            child: Column(children: [
                              ...
                              const Text('Bonus untukmu',
                                  style: TextStyle(color: XyTheme.muted, fontSize: 11.5)),
                            ]),
                          ),
                          Container(width: 1, height: 36, color: XyTheme.line),
                          Expanded(
                            child: Column(children: [
                        ...
                        const Text(
                          ...
                          style: TextStyle(color: XyTheme.muted, fontSize: 12.3, height: 1.55),
                        ),
                      ]),
                    ),
