    ...
    <div className="space-y-5 font-[var(--font-inter)]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="xy-card rounded-[16px] p-5">
          <h3 className="font-semibold text-[#1E1B2E] tracking-tight flex items-center gap-2"><Plus size={16} /> Tambah Produk</h3>
              ...
              {produk.map((p: any) => (
                <div key={p.id} className="xy-card rounded-[14px] p-4">
                  <div className="flex gap-3">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#7C3AED] to-[#A855F7] grid place-items-center text-white font-semibold tracking-tight">{(p.nama || "?")[0]}</div>
                    <div className="min-w-0 flex-1">
                      <div className="font-semibold text-[#1E1B2E] text-[13px] truncate tracking-tight">{p.nama}</div>
