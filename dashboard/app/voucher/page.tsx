    ...
    <div className="space-y-5 font-[var(--font-inter)]">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold text-[#1E1B2E] tracking-tight">Voucher</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="xy-card rounded-[16px] p-5">
          <h3 className="font-semibold text-[#1E1B2E] tracking-tight flex items-center gap-2"><Plus size={16} /> Buat Voucher</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {vouchers.map((v: any) => (
                <div key={v.id || v.kode} className="xy-card rounded-[14px] p-4">
                  <div className="flex items-center justify-between">
                    <span className="font-mono font-semibold text-[#1E1B2E] text-[14px] tracking-widest">{v.kode}</span>
