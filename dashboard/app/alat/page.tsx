  ...
  return (
    <div className="space-y-4 font-[var(--font-inter)]">
      <div className="flex items-center gap-3">
        ...
        <div><h1 className="text-xl font-semibold text-[#1E1B2E] tracking-tight">Email & Push</h1><p className="text-sm text-[#7C738F]">Alat uji kirim email & push notifikasi</p></div>
      </div>
      ...
      {out && <div className="xy-card p-4"><div className="text-[11px] font-semibold text-[#1E1B2E] mb-2">Hasil</div><pre className="text-[11px] text-[#7C738F] whitespace-pre-wrap">{out}</pre></div>}
    </div>
  );
}
