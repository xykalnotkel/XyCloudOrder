            ...
            <div key={r.id} className="xy-card rounded-[20px] p-5">
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-3 min-w-0">
                  <div className="w-9 h-9 shrink-0 rounded-xl bg-gradient-to-br from-[#7C3AED] to-[#5B21B6] grid place-items-center text-white font-black text-[13px]">
              ...
              {bukaId === r.id && (
                <div className="mt-3 flex gap-2">
                  ...
                  <button onClick={() => simpanBalas(r.id)} disabled={proses === "b_" + r.id} className="px-4 py-2 rounded-full xy-btn text-white font-bold text-[13px] h-fit disabled:opacity-50">
