    ...
    <div className="space-y-6 font-[var(--font-inter)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          ...
          <div key={c.label} className="xy-card rounded-[18px] p-5">
            ...
            <div className="text-xl font-bold text-[#1E1B2E] mt-1 tracking-tight">{c.value}</div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="lg:col-span-2 xy-card rounded-[18px] p-5">
          <h3 className="font-bold text-[#1E1B2E] tracking-tight flex items-center gap-2"><Rocket size={16} className="text-[#7C3AED]" /> Apa yang baru di v3.3?</h3>
