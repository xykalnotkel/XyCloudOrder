        ...
        <>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="xy-card rounded-[20px] p-5 space-y-3">
              <div className="flex items-center gap-2"><Activity size={15} className="text-[#7C3AED]" /><span className="text-[12px] font-bold text-[#1E1B2E]">Respons layanan</span></div>
              <div className="grid grid-cols-2 gap-3 text-[12px]">
                <div className="rounded-xl bg-[#F5F3FF] border border-[#E9E3F5] p-3"><div className="text-[10.5px] font-bold text-[#7C738F] uppercase">Wilayah Cloudflare</div><div className="font-black text-[#1E1B2E] mt-0.5 font-mono">{d.wilayah || "-"}</div></div>
                <div className="rounded-xl bg-[#F5F3FF] border border-[#E9E3F5] p-3"><div className="text-[10.5px] font-bold text-[#7C738F] uppercase">Waktu server</div><div className="font-black text-[#1E1B2E] mt-0.5">{d.waktu ? new Date(d.waktu).toLocaleString("id-ID") : "-"}</div></div>
              </div>
            </div>
            <div className="xy-card rounded-[20px] p-5 space-y-3">
              <div className="flex items-center gap-2"><Cloud size={15} className="text-[#7C3AED]" /><span className="text-[12px] font-bold text-[#1E1B2E]">Singgahan (cache)</span></div>
              ...
              <button onClick={bersihCache} disabled={busy} className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-white border border-[#E9E3F5] hover:border-rose-300 text-[12px] font-bold text-rose-600 disabled:opacity-50">
