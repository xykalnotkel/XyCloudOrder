  ...
  return (
    <div className="space-y-4 font-[Plus_Jakarta_Sans]">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-black text-white tracking-tight">Favorit <span className="ml-2 text-[10px] px-2 py-0.5 rounded-full bg-[#21114A] font-bold">BARU</span></h1>
          <p className="text-sm text-[#9A8CBF] font-medium">Produk paling banyak difavoritkan user, insight wishlist</p>
        </div>
      </div>
      ...
      <div className="xy-card rounded-xl p-4 text-[12px] text-[#6B5A8A]">TODO: endpoint /api/admin/favorit (agregasi favorit table). Saat ini belum ada endpoint, placeholder untuk v3.4.</div>
    </div>
  );
}
