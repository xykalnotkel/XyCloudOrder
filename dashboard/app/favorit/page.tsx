                ...
                <tbody>
                  {top.map((r, i) => (
                    <tr key={`${r.jenis}-${r.ref_id}-${i}`} className="border-b border-[#F0EDFB] last:border-0">
                      <td className="px-4 py-3 font-semibold text-[#7C738F]">{i + 1}</td>
                      <td className="px-4 py-3 font-semibold text-[#1E1B2E] flex items-center gap-2">
                      ...
                      <td className="px-4 py-3 font-semibold text-[#7C3AED]">{r.jumlah}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
